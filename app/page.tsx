...
import { LandingShowcase } from '@/components/visuals/landing-showcase';
        ...
        <div className="motion-enter space-y-6">
          {step === 0 && (
            <div className="space-y-6 text-ink/80">
              <div className="landing-hero rounded-2xl border border-stone/70 bg-gradient-to-br from-white to-[#f7f2e8] p-6">
                <p className="text-xs uppercase tracking-[0.22em] text-ink/50">Studio Ajuste · expérience premium</p>
                <h2 className="mt-2 text-3xl font-semibold leading-tight">De l'intention au devis qualifié, avec clarté et émotion.</h2>
                <p className="mt-3 text-base leading-relaxed text-ink/75">
                  Un parcours visuel inspiré des meilleures expériences de configurateur design : plus pédagogique, plus sensoriel, plus rassurant.
                </p>
              </div>
              ...
              <div className="grid gap-3 md:grid-cols-3">
                {['Parcours premium', 'Schémas animés', 'Estimation évolutive'].map((item) => (
