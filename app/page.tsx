...
const furnitureTypes: { value: FurnitureType; label: string; description: string }[] = [
  { value: 'bibliotheque', label: 'Bibliothèque', description: 'Structure murale élégante et modulable.' },
  { value: 'meuble-tv', label: 'Meuble TV', description: 'Meuble bas ou semi-haut intégrant médias et rangement.' }
];
      ...
      <section className="card">
        ...
        {step === 0 && (
          <div className="space-y-5 text-ink/80">
            <p className="text-lg leading-relaxed">
              Un assistant premium pour transformer une intention en brief qualifié, avec une estimation indicative claire.
            </p>
            <ul className="list-disc pl-5 text-sm space-y-1">
              <li>Parcours guidé en 8 étapes courtes</li>
              <li>Projection simple via grille modulaire</li>
              <li>Préqualification exploitable côté studio + n8n</li>
            </ul>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {furnitureTypes.map((item) => (
              <button
                ...
                className={`rounded-2xl border p-5 text-left ${state.furnitureType === item.value ? 'border-ink bg-warm' : 'border-stone'}`}
              >
        ...
        {step === 6 && (
          <div className="space-y-4">
            ...
            <p className="text-sm text-ink/70">Estimation indicative à confirmer après étude des contraintes techniques et esthétiques.</p>
